		...
		{	
			...
			setSelected : function(d, v, moveToMonth, dispatchEvents)
			{
				...
				if (d < this.startDate || d > this.endDate) {
					...
					//return;	// comment this line by Amit for resolving issue => end date selection issue with escape date
				}
				var s = this.settings;
				if (s.selectWeek)
				{
				...
				{
					//return;	// comment this line by Amit for resolving issue => reset button form not allow same date selection
				}
